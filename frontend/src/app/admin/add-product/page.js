...
const SUB_CATEGORIES = {
  Men: ["T-Shirts", "Shirts", "Jeans", "Trousers", "Hoodies", "Jackets", "Ethnic", "Track Pants", "Shoes"],
  Women: ["Sarees", "Suits", "Ethnic Sets", "Dresses", "Kurtas", "Tops", "Co-ord Sets", "Bottoms", "Footwear", "Accessories"],
