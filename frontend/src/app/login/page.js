      ...
      <div className="auth-root">
          ...
          <div className="auth-left-content">
            <div className="auth-logo">
              ...
              <div className="auth-logo-line">
                ...
                <span className="auth-logo-sub">Fashion</span>
              </div>
            </div>
        ...
        <div className="auth-right">
          ...
          <div className="auth-mobile-logo" style={{ marginBottom: '24px' }}>
            <span className="auth-logo-name" style={{ color: '#f5efe6', fontFamily: "'Cormorant Garamond', serif", fontSize: '1.8rem', letterSpacing: '0.35em' }}>KIA</span>
            <div className="auth-logo-line">
              <div className="auth-logo-bar" />
              <span className="auth-logo-sub">Fashion</span>
            </div>
          ...
          {(mode === 'login' || mode === 'signup') && (
            <>
              <div className="auth-header">
                ...
                <p>{mode === 'login' ? 'Enter your credentials to access your wardrobe, orders & wishlist.' : 'Join KIA Fashion for exclusive access to new arrivals and offers.'}</p>
              </div>
